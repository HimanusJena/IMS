...
class salesClass:
    def __init__(self,root):
        ...
        txt_invoice=Entry(self.root,text="Invoice No.",textvariable=self.var_invoice,font=("times new roman",15),bg="lightyellow").place(x=160,y=100,width=150,height=28)
        ...
        #image
        self.bill_photo=Image.open("cat2.jpg")
        self.bill_photo=self.bill_photo.resize((450,300))
        self.bill_photo=ImageTk.PhotoImage(self.bill_photo)

        lbl_img=Label(self.root,image=self.bill_photo,bd=0)
