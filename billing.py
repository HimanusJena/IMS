...
class BillClass:
    def __init__(self,root):
        ...
        #button logout
        btn_logout=Button(self.root,command=self.logout,text="Logout",font=("times new roman",15,"bold"),bg="yellow",cursor="hand2").place(x=1150,y=10,relwidth=1,height=50,width=150)
        ...
        btn_search=Button(ProductFrame2,command=self.search,text="Search",font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=285,y=45,width=100,height=25)
        btn_show_all=Button(ProductFrame2,command=self.show,text="Show All",font=("goudy old style",15),bg="#083531",fg="white",cursor="hand2").place(x=285,y=10,width=100,height=25)
        ...
        btn_c=Button(Cal_Frame,text='C',font=('arial',15,'bold'),command=self.clear,bd=5,width=4,pady=15,cursor='hand2').grid(row=4,column=1)
        ...
        btn_clear_cart=Button(Add_Cart_Widget_Frame,command=self.clear_cart,text="Clear",font=("times new roman",15,"bold"),bg="lightgray",cursor="hand2").place(x=180,y=70,width=150,height=30)
        btn_add_cart=Button(Add_Cart_Widget_Frame,command=self.add_update_cart,text="Add | Update Cart",font=("times new roman",15,"bold"),bg="orange",cursor="hand2").place(x=340,y=70,width=180,height=30)

        #billing area
        billFrame=Frame(self.root,bd=2,relief=RIDGE,bg='white')
        billFrame.place(x=953,y=110,width=410,height=410)

        bTitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",15,"bold"),bg="#f44336",fg='white').pack(side=TOP,fill=X)
        ...
        #footer
        footer=Label(self.root,text="Inventory Management System | Developed By Himansu & Dinesh t\nFor any Technical Issue contact: 7749958***",font=('times new roman',11),bg='#4d636d',fg='white',bd=0,cursor='hand2').pack(side=BOTTOM,fill=X)
        self.show()
        #self.bill_top()
    ...
    def show(self):
        ...
        try:
            ...
            messagebox.showerror("error",f"Error due to(row[]):{str(ex)}",parent=self.root)
            ...
            if present=='yes':
                    ...
                    if op==True:
                        if self.var_qty.get()=="0":
                            self.car_list.pop(index_)
                        else:
                            #self.car_list[index_][2]=price_cal
                            self.car_list[index_][3]=self.var_qty.get()
            else:
                self.car_list.append(cart_data)
            self.show_cart()
    ...
    def bill_update(self):
        ...
        self.cartTitle.config(text=f"Cart \t Total Product: [{str(len(self.car_list))}]")
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ-Inventory
\t Phone No. 8828784773 , Mumbai-400054
{str("="*47)}
...
{str("="*47)}\n
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"Welcome to Inventory management System\t\t Date: {str(date)}\t\t Time: {str(time_)}")
