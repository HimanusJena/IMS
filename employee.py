...
class employeeClass:
    def __init__(self,root):
        ...
        #options
        cmb_search=ttk.Combobox(SearchFrame,values=("Select","Email","Name","Contact"),textvariable=self.var_searchby,state="readonly",justify=CENTER,font=("goudy old style",15))
        ...
        #row4
        lbl_address=Label(self.root,text="Adress",font=("goudy old style",15),bg="white").place(x=50,y=270)
        lbl_salary=Label(self.root,text="Salary",font=("goudy old style",15),bg="white").place(x=500,y=270)
       
        self.txt_addresss=Text(self.root,font=("goudy old style",15),bg="lightyellow")
        self.txt_addresss.place(x=150,y=270,width=300,height=60)
        ...
        #button
        btn_add=Button(self.root,text="Save",command=self.add,font=("italic",15),bg="red",fg="white",cursor="hand2").place(x=500,y=305,width=110,height=28)
            ...
            if self.var_emp_id.get()=="":
                ...
                if row!=None:
                    ...
                    cur.execute("Insert into employee(eid,name,email,gender,contact,dob,doj,pass,utype,address,salary) values(?,?,?,?,?,?,?,?,?,?,?)",(
                        ...
                        self.txt_addresss.get('1.0',END),
                        self.var_salary.get(),
                    ))
                    con.commit()
                    messagebox.showinfo("Success","Emoloyee Added Successfully",parent=self.root)
                    self.show()
    ...
    def get_data(self,ev):
        ...
        self.txt_addresss.delete('1.0',END),
        self.txt_addresss.insert(END,row[9]),
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Emoloyee Updated Successfully",parent=self.root)
                    self.show()
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    op=messagebox.askyesno("Confirm","Do you really wnat to delete?")
                    if op==True:
